...
def main():
  ...
  #fig = get_energy_comparison_histogram(10000)
  #fig.show()
  #fig.savefig("/nashome/t/tlabree/img/"+today+"/tau_energy_flux.svg")

  #fig2 = get_energy_loss_comparison_histogram(10000)
  #fig2.show()
  #fig2.savefig("/nashome/t/tlabree/img/"+today+"/tau_energy_loss.svg")

  #fig3 = get_scattering_angle_comparison_histogram(10000)
  #fig3.show()
  #fig3.savefig("/nashome/t/tlabree/img/"+today+"/tau_scattering_angle.svg")

  #fig4 = get_interaction_type_bar_graph(10000)
  #fig4.show()
  #fig4.savefig("/nashome/t/tlabree/img/"+today+"/tau_interaction_types.svg")

  #fig5 = get_tau_decay_product_list(10000)
  #fig5.show()
  #dump_particle_list_dunesw("prodgenie_nutau_dune10kt_gen.root", 26)

  #fig6 = get_charged_hadron_angle_histogram(10000)
  #fig6.show()
  #fig6.savefig("/nashome/t/tlabree/img/"+today+"/charged_hadron_angle.svg")

  #fig7 = get_charged_hadron_energy_histogram(10000)
  #fig7.show()
  #fig7.savefig("/nashome/t/tlabree/img/"+today+"/charged_hadron_energy.svg")

  #fig8 = get_charged_hadron_count_histogram(10000)
  #fig8.show()
